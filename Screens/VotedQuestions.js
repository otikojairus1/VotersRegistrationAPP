...
let data=[];
export default function VotedQuestions({navigation}) {
  ...
  const [isLoading, setIsLoading] = useState(true);
    useEffect(() => {
      data = [];
        ...
        fetch('https://voterappapi.herokuapp.com/api/all/votes')
