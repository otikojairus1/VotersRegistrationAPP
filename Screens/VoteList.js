...
let data = [];
export default function VoteList({ navigation, route }) {
  ...
  return (
    <NativeBaseProvider>
      <Box bg="white" flex="1" safeAreaTop>
        ...
        <Basic email={email} nav={navigation} />
      </Box>
    </NativeBaseProvider>
  );
}
      ...
      >
        <Box pl="4" pr="5" py="2">
          <HStack alignItems="center" space={3}>
            <Avatar
              size="48px"
              source={require("../assets/userdp.jpeg") }
            />
            ...
            <VStack>
              ...
              <Text color="coolGray.600" _dark={{ color: "warmGray.200" }}>
                Question reference number {item.id}
              </Text>
            </VStack>
            <Spacer />
            <Text
